/* Set de iconos de la interfaz — trazo Feather, un solo componente para que el
   grosor, el tamaño y el color sean consistentes en toda la aplicación. */
...
const PATHS = {
  ...
  board:      <><rect x="3" y="3" width="5" height="18" rx="1"/><rect x="10" y="3" width="5" height="13" rx="1"/><rect x="17" y="3" width="4" height="16" rx="1"/></>,
  chart:      <><path d="M3 3v18h18"/><path d="M7 15l3.5-4 3 3L21 7"/></>,
...
export default function Icon({ name, size = 16, stroke = 2, className, style }) {
